---
title: "Visualizing Primary Productivity Trends for the Legacy and Interim Products"
...
In this notebook, users will visualize linear trends and p-values for primary productivity.
...
We calculated the pixel-by-pixel trend coefficients and p-values for the globe for each monthly at a 9km resolution across three datasets:
...
The dataset ID is: **trends_noaa20_monthly_9km**.
